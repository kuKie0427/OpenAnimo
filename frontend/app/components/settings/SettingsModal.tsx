...
export function SettingsModal() {
	...
	const renderConfigItem = (item: ConfigItem) => (
		<div
			key={item.key}
			className="bg-base-200 p-4 rounded-lg border border-base-content/30"
		>
	...
	const renderTextSection = () => {
		...
		return (
			<div className="space-y-6">
				...
				{/* 服务提供商选择 */}
				{providerItem && (
					<div className="bg-base-200 p-4 rounded-lg border border-base-content/30">
	...
	return (
		...
		>
			<div className="modal-box w-11/12 max-w-5xl max-h-[90vh] border border-base-content/10 shadow-projection bg-base-100 p-0 flex flex-col">
				{/* 头部 */}
				<div className="flex items-center justify-between px-6 py-4 border-b border-base-content/10 bg-base-200 shrink-0">
				...
				{isError && (
					<div className="p-6">
						<div
							role="alert"
							className="alert alert-error border border-base-content/30"
						>
				...
				{config && (
					...
					>
						{/* 标签页导航 */}
						<div className="px-4 py-3 border-b border-base-content/10 bg-base-100 shrink-0">
                        ...
                        border border-base-content/30 transition-all
                        ${
													isActive
														? "bg-accent text-accent-content shadow-aperture"
                      ...
                      `}
						...
						{/* 底部操作栏 */}
						<div className="border-t border-base-content/10 bg-base-200 px-6 py-4 flex items-center gap-4 shrink-0">
							<div className="flex items-center gap-2 text-info text-sm flex-1 min-w-0">
							...
							<button
								type="button"
								onClick={handleCancel}
								className="btn border border-base-content/30"
							>
								取消
							</button>
							...
							<button
								type="submit"
className="btn btn-primary border border-base-content/30"
							...
							<button
								type="button"
								className="btn btn-outline border border-base-content/30"
			...
			{alertState.show && (
				<div
					className="modal modal-open"
					onKeyDown={(e) => {
						if (e.key === "Escape") setAlertState({ ...alertState, show: false });
					}}
					onClick={(e) => {
						if (e.target === e.currentTarget) setAlertState({ ...alertState, show: false });
					}}
				>
					<div className="modal-box border border-base-content/10 shadow-projection">
						<div className="flex items-start gap-3">
							...
							<div className="flex-1">
								...
								{alertState.details && (
									<div className="mt-3 p-3 bg-base-200 rounded-lg border border-base-content/30">
